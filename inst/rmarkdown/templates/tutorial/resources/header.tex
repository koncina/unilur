...
% Transforms itemize items into multiple choice questions
...
\NewEnviron{oneparchoices}[1][\perline]{%
...
\Alph{q})\space}\strut\csname inlineitem@\i\endcsname\strut}\hspace{0pt}}%
}
...
\newcommand{\mcq}[2][3]{
  ...
  \ifstrequal{#2}{on}{
    ...
    % Switching itemize back to initial mode
    \let\itemize\olditemize
...
% fillwithdottedlines macro
% Draws dotted lines to write a response
% Taken from the exam class
