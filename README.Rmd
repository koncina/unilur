...
This template introduces additional tools such as the:

- Creation of colored boxes to highlight some markdown or _R_ content.
- Generate a *rmarkdown* file without solutions to allow students to fill in their answers
- An *examen* mode allowing:
...
The library contains example templates illustrating some of the different possibilities.
...
You can also use markdown by writing it within an _asis_ chunk instead of an _r_ one:  
...
```{r}
knitr::include_graphics("http://eric.koncina.eu/unilur/img/solution.jpg")
```
...
```{r}
knitr::include_graphics("http://eric.koncina.eu/unilur/img/colorbox.jpg")
```

## Examen

The examen mode (which relies on the latex [exam class](https://www.ctan.org/pkg/exam)) can be enabled in the YAML front-matter by defining the `exam` argument to `yes` or with additional arguments such as:
...
```{r}
knitr::include_graphics("http://eric.koncina.eu/unilur/img/exam_questions.jpg")
knitr::include_graphics("http://eric.koncina.eu/unilur/img/exam_solution.jpg")
```
...
|     mcq theme          |  result                                                            |
|:----------------------:|:------------------------------------------------------------------:|
| `oneparchoices`        | ![](http://eric.koncina.eu/unilur/img/mcq_oneparchoices.jpg)       |
| `oneparchoicesalt`     | ![](http://eric.koncina.eu/unilur/img/mcq_oneparchoicesalt.jpg)    |
| `oneparcheckboxes`     | ![](http://eric.koncina.eu/unilur/img/mcq_oneparcheckboxes.jpg)    |
| `oneparcheckboxesalt`  | ![](http://eric.koncina.eu/unilur/img/mcq_oneparcheckboxesalt.jpg) |
