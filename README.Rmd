...
- a PDF or HTML file with the exam or tutorial questions (answers remaining hidden) as a PDF or HTML file.
- the same output as above but with the answers appearing in coloured boxes. 
- a cleaned up Rmarkdown file (without answers) to be filled by the candidate.
...
You can read [these articles](http://koncina.github.io/unilur/articles/index.html) to find more informations on how to use the `unilur` formats:
